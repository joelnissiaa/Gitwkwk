...
if ($result->num_rows > 0) {
    ...
    $pdf->Cell(19, 10, 'ID', 1);
    $pdf->Cell(22, 10, 'Produk', 1);
    $pdf->Cell(23, 10, 'Jumlah', 1);
    $pdf->Cell(25, 10, 'Harga', 1);
    $pdf->Cell(40, 10, 'Deskripsi', 1);
    $pdf->Cell(39, 10, 'Tanggal', 1);
...
while($row = $result->fetch_assoc()) {
    ...
    $pdf->Cell(19, 26.5, $row['idproduk'], 1);
    $pdf->Cell(22, 26.5, $row['namaproduk'], 1);
    $pdf->Cell(23, 26.5, $row['jumlah'], 1);
    $pdf->Cell(25, 26.5, $row['harga'], 1);
    $pdf->Cell(40, 26.5, $row['deskripsi'], 1);
    $pdf->Cell(39, 26.5, $row['tanggal'], 1);
    
    // Kolom Foto - Menampilkan gambar
    $fotoPath = 'assets/img/produk/' . $row['foto'];  // Path foto sesuai dengan lokasi penyimpanan
